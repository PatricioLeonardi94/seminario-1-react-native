...
const CameraScreen = ({navigation}) => {
    ...
    if (hasPermission === null) {
        return <View><Text>Para acceder a la camara, es neceario que brindes el correspondiente permiso</Text></View>;
    }
    if (hasPermission === false) {
        return <View><Text>No ahas concedido acceso a la camera</Text></View>;
    }
    return (
